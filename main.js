...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (toggleButton && timelineOverlay && closeButton) {
    ...
    console.error(
      "Timeline toggle button, overlay, or close button not found."
    );
  }
});
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", (e) => {
    if (
      ...
      !navbarMenu.contains(e.target) && // not clicking inside menu
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const imgLinks = document.querySelectorAll(".image-popup");
